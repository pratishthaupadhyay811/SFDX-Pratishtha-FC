...
inboxApp.directive("inboxComponent", function() 
        ...
        return {
            ...
            templateUrl : staticResourcePath + '/application_js/templates/inbox-template-slds.html',
            link : function($scope, element, attr )
            {
                ...
                $scope.showcontent = function(d) {
                    ...
                    Visualforce.remoting.Manager.invokeAction(
                        'FGM_Portal.CommunityDashboardController.setEmailContent',
                        $scope.activities[d].activity.Id,$scope.activities[d].mailStatus,
                ...
                $scope.deleteMessage = function() {
                    if ($('input[id$=chkId]').length > 0) {
                        if (confirm(confirmDeleteLabel)) {
                            ...
                            if (checkid.length > 0) {
                                Visualforce.remoting.Manager.invokeAction(
                                    'FGM_Portal.CommunityDashboardController.delMessage',
